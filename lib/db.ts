...
export async function seedDatabase() {
  try {
    ...
    const siteContentDefaults = [
      ...
      { id: 'sc-home-about-feat1-title', key: 'home_about_feature_1_title', value: 'Transparent Pricing', label: 'Feature 1 Title', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat1-desc', key: 'home_about_feature_1_desc', value: 'Honest quotes, no hidden fees', label: 'Feature 1 Description', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat2-title', key: 'home_about_feature_2_title', value: 'Experienced Team', label: 'Feature 2 Title', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat2-desc', key: 'home_about_feature_2_desc', value: 'Trained and careful technicians', label: 'Feature 2 Description', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat3-title', key: 'home_about_feature_3_title', value: 'Locally Owned', label: 'Feature 3 Title', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat3-desc', key: 'home_about_feature_3_desc', value: 'Brisbane family business', label: 'Feature 3 Description', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat4-title', key: 'home_about_feature_4_title', value: 'Thorough Inspections', label: 'Feature 4 Title', group: 'home', type: 'text' },
      { id: 'sc-home-about-feat4-desc', key: 'home_about_feature_4_desc', value: 'Post-job inspection on every service', label: 'Feature 4 Description', group: 'home', type: 'text' },
