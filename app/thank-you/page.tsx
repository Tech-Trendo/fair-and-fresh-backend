        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-white rounded-xl border border-border shadow-sm p-8 md:p-10 text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
              <Button asChild className="rounded-full bg-accent hover:bg-accent-dark text-primary-foreground font-nav text-sm px-7">
                <Link href="/">Return to Home</Link>
              </Button>
              <Button asChild variant="outline" className="rounded-full border-accent text-accent hover:bg-accent hover:text-primary-foreground font-nav text-sm px-7 bg-transparent">
