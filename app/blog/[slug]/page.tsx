            ...
            <aside className="space-y-8 lg:sticky lg:top-24 h-fit">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 p-6 shadow-md">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <Link href="/quote" className="inline-flex items-center justify-center w-full h-11 px-4 py-2.5 rounded-xl bg-accent text-primary-foreground font-bold hover:bg-accent-dark transition-all text-xs text-center shadow-sm">
                    Get Free Quote Now
                  </Link>
                </div>
              </div>
