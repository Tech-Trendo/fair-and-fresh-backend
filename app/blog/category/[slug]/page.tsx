          ...
          {postsList.length === 0 ? (
            <div className="text-center py-20 border border-dashed border-border rounded-2xl bg-card">
              ...
              <div className="mt-6">
                <Link
                  href="/blog"
                  className="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-accent text-primary-foreground font-bold hover:bg-accent-dark transition-all text-xs"
                >
                  View All Articles
                </Link>
              </div>
