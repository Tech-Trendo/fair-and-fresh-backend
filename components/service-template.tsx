        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary rounded-xl px-8 py-14 md:px-16 md:py-20 text-center">
            ...
            <FadeIn delay={0.2} className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/quote"><Button size="lg" className="rounded-full bg-white text-primary hover:bg-white/90 font-nav text-base px-8">Get Free Quote <ArrowRight className="ml-2 h-4 w-4" /></Button></Link>
